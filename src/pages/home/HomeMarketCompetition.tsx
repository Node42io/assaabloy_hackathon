 ...
 *   - Item 26: Source callout for customer briefing + SourceFootnote RS016/RS034
    ...
    <section id="section-04" className="container">
      ...
      <div className="md">
        ...
        <ExecutiveSummary kicker="04 / Executive Summary" title="What you are reading">
          <p className="answer">
            This chapter maps the competing technologies currently serving the building security
            emergency exit protection slot that the GfS Türwächter IoT targets. For each technology
            you will see: the physical mechanism, estimated market-share tier,
            key vendors, strengths and weaknesses, and a technology-specific
            switching-cost assessment. This matters because switching cost determines how fast
            GfS can displace incumbents, even when the technical case is clear.
          </p>
        </ExecutiveSummary>
        ...
        <div className="source-callout" style={{
          ...
          Source: GfS Rettungswegtechnik customer briefing (internal)
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Spring-Loaded Mechanical Guard with Piezoelectric Alarm + Wireless Monitoring</td>
            </tr>
            <tr>
        ...
        <p>
          This is the Türwächter's <strong>home market</strong> — the emergency exit door
          security slot in commercial, public, and institutional buildings. Building operators,
          facility managers, and security integrators install door alarm guards to prevent
          unauthorized use of emergency exits while maintaining full escape capability in
          compliance with fire safety regulations.
          <SourceFootnote sourceIds={["RS001", "RS028", "RS032"]} />
          {" "}Building codes and fire safety regulations mandate that emergency exits remain
          usable at all times, making security solutions that preserve escape capability a
          regulatory requirement rather than an optional component.
        ...
        <div className="answer-box">
          <h3>Key Insight</h3>
          <p className="answer">
            The GfS Türwächter IoT combines a <strong>physical deterrent guard</strong>{" "}
            with <strong>audible alarm</strong> and <strong>wireless remote monitoring</strong>{" "}
            in a single battery-powered, retrofit-friendly device. Its primary competitive
            advantage is the combination of mechanical deterrence with IoT connectivity that
            competing products typically offer only separately.
            <SourceFootnote sourceIds={["RS001", "RS002", "RS003"]} />
            {" "}The secondary advantage is the{" "}
            <strong>retrofit simplicity</strong> — no wiring, no door modification, no
            integration with fire alarm systems required for basic installation.
        ...
        <table>
          ...
          <tbody>
            {[
              ...
              ["Subject technology excluded from list", "Complete — Mechanical Guard + Piezo Alarm + Wireless not listed"],
