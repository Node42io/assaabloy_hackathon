    ...
    <section id="section-03" className="container">
      ...
      <div className="md">
        ...
        <ExecutiveSummary kicker="03 / Executive Summary" title="What you are reading">
          <p className="answer">
            This chapter maps the constraints that bound the Türwächter's addressable
            market scope — covering physical, regulatory, operational, economic, and
            environmental limits. Absolute constraints cannot be overcome by any
            engineering change or investment; the remaining conditional constraints can be
            mitigated at varying cost and lead time. Every new market candidate in Chapter 05
            is screened against these constraints: absolute violations eliminate a market
            entirely, while conditional barriers reduce its fit score and add a cost-to-enter
            estimate.
          </p>
        </ExecutiveSummary>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>Absolute constraints from the constraint list above</td>
            </tr>
            <tr>
              ...
              <td>Conditional constraints from the constraint list above</td>
            </tr>
          </tbody>
        </table>
