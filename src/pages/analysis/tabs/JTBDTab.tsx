    ...
    <div className="section">
      ...
      <div style={{ marginTop: 56 }}>
        <div style={{ marginBottom: 16 }}>
          ...
          >
            ...
            directly relevant to emergency exit security; dimmed steps represent phases
            where the Türwächter has limited or no touchpoint.
          </p>
        </div>
      ...
      <div style={{ marginTop: 56 }}>
        <div style={{ marginBottom: 16 }}>
          ...
          >
            Key roles involved in purchasing, operating, and maintaining emergency exit
            security solutions in this market — and their JTBD pyramid level
