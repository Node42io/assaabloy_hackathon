    ...
    <div className="section">
      ...
      <ExecutiveSummary kicker="What you are reading" title="Bill of Materials Analysis">
        <p className="answer">
          ...
          Reading the BOM for market entry reveals <strong>where the Türwächter fits
          in the physical product architecture</strong> — whether it is a critical security
          component inside the OEM's assembly (e.g., inside emergency exit door hardware) or
          a piece of safety equipment that monitors how the facility is secured (e.g.,
          door alarm in a healthcare facility).
        </p>
        <p className="answer" style={{ marginTop: 12 }}>
          ...
          badge are the subsystems or modules where the Exit Control 179/1125 competes directly.
        </p>
      </ExecutiveSummary>
        ...
        <>
          ...
          <ExecutiveSummary kicker="How to read this table">
            <p className="answer">
              ...
              BOM position where the Türwächter competes.
            </p>
          </ExecutiveSummary>
