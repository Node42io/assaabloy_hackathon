    ...
    <div className="section">
      ...
      <ExecutiveSummary kicker="Alternatives / Executive Summary">
        <p className="answer">
          ...
          could use <em>instead of</em> the GfS Türwächter IoT to fulfil their
          emergency exit security need. An "alternative" here means any technology, workaround, or
        ...
        <p className="answer">
          ...
          inherent trade-offs of each alternative and how does the Türwächter's alarm-guard approach
